...
import {AddContactRepository, Contact, ContactModelRepository,} from "./usecase/add-contact-repository";
import {ContactModel} from "../models/contact.model";

@EntityRepository(ContactModel)
export class ContactRepository extends AbstractRepository<ContactModel> implements AddContactRepository {
    ...
    async list(): Promise<ContactModelRepository[]> {
        const contacts = await
            this.repository.find({order: {id: "DESC"}})
